...
const trialWelcomeMessage = [
  {
    name: `${config.emoji.owoKiwi}  Server Tour`,
    value:
  ...
  {
    name: `${config.emoji.owoKiwi}  Mods & Resources`,
  ...
  {
    name: `${config.emoji.owoKiwi}  Server Info`,
  ...
  {
    name: `${config.emoji.owoKiwi}  Todo on KiwiTech`,
  ...
  {
    name: '\u200b',
    value: `*The most important thing on KiwiTech is to have fun! If you have any questions, you can always ask us anything in member channels or ingame. We are also active in VC!*  ${config.emoji.froghypers}`,
  },
];
